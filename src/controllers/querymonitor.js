...
qryCtrlMonitor.EditCheckPoint = async (req, res) => {
    ...
    try {
        console.log(req.body);
         ...
         let values=[checkpoints.id_ruta];
         ...
         if(rows.length==0){
            ...
            for (let y = 0; y < rows.length; y++) {
                ...
                let values2 = [checkpoints.id_ruta, checkpoints.checkpoints[y].id_punto, checkpoints.checkpoints[y].name_punto,checkpoints.checkpoints[y].hora,checkpoints.checkpoints[y].fecha];
